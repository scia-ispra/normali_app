...
trovaRegioniAeronautica<-function(ana){
  ...
  purrr::map_dfr(regioni[-grep("italia",regioni)],.f=function(nomeRegione){
  ...
  purrr::map2(.x=c("aeronautica_6749","aeronautica_6710","aeronautica_6711","aeronautica_6858","aeronautica_6750","aeronautica_6691"),.y=c("toscana","lombardia","piemonte","basilicata","toscana","veneto"),.f=function(.x,.y){
